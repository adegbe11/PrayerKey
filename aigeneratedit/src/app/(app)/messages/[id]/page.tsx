  ...
  return (
    <div style={{ position: 'absolute', inset: 0, background: '#fff', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        <button
          onClick={() => router.back()}
          style={{ width: 36, height: 36, borderRadius: '50%', background: '#f5f5f5', border: 'none', cursor: 'pointer', fontSize: 16, display: 'flex', alignItems: 'center', justifyContent: 'center' }}
        >
          ←
        </button>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 12, color: '#999' }}>
            ✈ {match.profile.destinations[0]} · Matched {new Date(match.matchedAt).toLocaleDateString()}
          </div>
        </div>
        ...
        {/* Menu */}
        <button style={{ width: 36, height: 36, borderRadius: '50%', background: '#f5f5f5', border: 'none', cursor: 'pointer', fontSize: 20, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#737373' }}>
          ⋯
        </button>
      </div>
        ...
        <div style={{
          ...
          <input
            ...
            style={{
              ...
              outline: 'none', fontSize: 15, color: '#141414',
              fontWeight: 500,
            }}
          />
        </div>
